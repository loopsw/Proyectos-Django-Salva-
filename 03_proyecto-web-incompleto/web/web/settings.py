...
SECRET_KEY = 'django-insecure-h8g5k_4)qv9vmgn1un&!bpa6+b^ju*mrxsgezk83=wt*d1^&wj'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/'anuncios/templates/anuncios/html/',BASE_DIR/'sendemail/templates/sendemail/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# MEDIA STATICS
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'anuncios/media'
